  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status = 'success') location.reload(true); // reload true means the reloaded page will be loaded from the server and not from the browser cache
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2xla3NhbmRyb3pob2giLCJhIjoiY2x1ZWU2ZTg3MXJ4djJtbGRwNzZhemtoaCJ9.IRTOw7wmwB3Y_mQrfyox-g';
...
var userPasswordForm = document.getElementsByClassName('form-user-password');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    ...
    var passwordUpdate = document.getElementById('password').value;
    var passwordUpdateConfirm = document.getElementById('password-confirm').value;
    (0, _updateSettings.updateSettings)({
      password: password,
      passwordUpdate: passwordUpdate,
      passwordUpdateConfirm: passwordUpdateConfirm
    }, 'password');
